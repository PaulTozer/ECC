...
function buildExpectedPublishPaths(repoRoot) {
  ...
  const extraPaths = [
    ...
    "scripts/copilot-hook.js",
    "scripts/copilot-package.js",
  ...
  const tests = [
    ...
    ["npm pack --ignore-scripts publishes the reduced runtime surface (prepack not tested)", () => {
      ...
      for (const requiredPath of [
        ...
        "scripts/copilot-hook.js",
        "scripts/copilot-package.js",
        "scripts/lib/copilot/files.js",
        "scripts/lib/copilot/hook.js",
        "scripts/lib/copilot/markdown.js",
        "scripts/lib/copilot/package.js",
        "scripts/feedback.js",
        "scripts/ito.js",
        "scripts/memory.js",
        "scripts/memory-mcp.mjs",
